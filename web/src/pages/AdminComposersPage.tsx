    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2 text-sm">
        ...
        >
          ...
          <option value="correct">{t("composers.reviewCorrect")}</option>
          <option value="incorrect">{t("composers.reviewIncorrect")}</option>
          <option value="reviewed">{t("composers.reviewReviewed")}</option>
          <option value="not_reviewed">{t("composers.reviewNotReviewed")}</option>
        </select>
      </div>
